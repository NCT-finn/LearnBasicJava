            ...
            <table class="table table-striped">
                ...
                <c:forEach var="employeeModel" items="${employeeModels}">
                    <tr>
                        ...
                        <td>${employeeModel.nameEmployee}</td>
                        <td>${employeeModel.position}</td>
                        <td>${employeeModel.salary}</td>
                        <td>${employeeModel.departmentName}</td>
                        <td>${employeeModel.hireDate}</td>
                        <td hidden = "true">${employeeModel.departmentId}</td>
                        <td>
                            <div class="row">
                                <div class="col">
<%--                                    <button type="button" class="btn btn-outline-danger">Delete</button>--%>
                                    <a class="btn btn-danger" href="/employee/delete?employeeId=${employeeModel.employeeId}" role="button">Xóa</a>
                                    <a class="btn btn-success me-2" href="/employee/update?employeeId=${employeeModel.employeeId}&departmentId=${employeeModel.departmentId}" role="button">Sửa</a>
                                </div>
                            </div>
                        </td>
                    </tr>
